...
//            writer.close();
            ...
            //
            // if (Files.exists(Paths.get("../output/ostrowski.Alg2.txt"))) {
            //     Files.delete(Paths.get("../output/ostrowski.Alg2.txt"));
            // }
            // Files.createFile(Paths.get("../output/ostrowski.Alg2.txt"));
            // Files.write(ostrowski.Alg2.allStatesToString(),Paths.get("../output/ostrowski.Alg2.txt"), StandardCharsets.UTF_16);
            //
            ...
            // }
            // Files.createFile(Paths.get("../output/ostrowski.Alg0.txt"));
            // Files.write(ostrowski.Alg0.allStatesToString(), Paths.get("../output/ostrowski.Alg0.txt"), StandardCharsets.UTF_16);
        }
