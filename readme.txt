...
eval lsd_sqrt2_addition "(Ey (Ex (Ew $alg0(a,b,w) & `$alg1(w,x)) & $alg2(x,y)) & `$alg3(y,c)) & $rrt2(c)":

The final automaton, named "lsd_sqrt2_addition", can be found in "/Result" folder of Walnut.
